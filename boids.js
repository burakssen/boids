...
var ASM_CONSTS = {
  88996: () => { if (document.fullscreenElement) return 1; },  
 89042: () => { return document.getElementById('canvas').width; },  
 89094: () => { return parseInt(document.getElementById('canvas').style.width); },  
 89162: () => { document.exitFullscreen(); },  
 89189: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 89262: () => { if (document.fullscreenElement) return 1; },  
 89308: () => { return document.getElementById('canvas').width; },  
 89360: () => { return screen.width; },  
 89385: () => { document.exitFullscreen(); },  
 89412: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 89545: () => { if (document.fullscreenElement) return 1; },  
 89591: () => { return document.getElementById('canvas').width; },  
 89643: () => { return parseInt(document.getElementById('canvas').style.width); },  
 89711: () => { if (document.fullscreenElement) return 1; },  
 89757: () => { return document.getElementById('canvas').width; },  
 89809: () => { return screen.width; },  
 89834: () => { if (document.fullscreenElement) return 1; },  
 89880: () => { return document.getElementById('canvas').width; },  
 89932: () => { return screen.width; },  
 89957: () => { document.exitFullscreen(); },  
 89984: () => { if (document.fullscreenElement) return 1; },  
 90030: () => { return document.getElementById('canvas').width; },  
 90082: () => { return parseInt(document.getElementById('canvas').style.width); },  
 90150: () => { document.exitFullscreen(); },  
 90177: () => { return screen.width; },  
 90202: () => { return screen.height; },  
 90228: () => { return window.screenX; },  
 90255: () => { return window.screenY; },  
 90282: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90335: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 90406: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 90463: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 90534: () => { if (document.fullscreenElement) return 1; },  
 90580: () => { if (document.pointerLockElement) return 1; }
};
